package it.intesys.rookie.utilities;
...
public class Utilities {
    ...
    protected static <T> HttpHeaders paginationHeaders(Page<T> page, String baseUrl) {
    ...
    public static String pagingQuery(StringBuilder query, Pageable pageable) {
        String orderSep = "";
